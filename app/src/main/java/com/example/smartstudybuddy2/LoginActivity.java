...
//        }
        ...
        googleSignUpBtn.setOnClickListener(v -> {
            Toast.makeText(LoginActivity.this, "Google SignUp Coming Soon!", Toast.LENGTH_SHORT).show();
        });

        facebookSignUpBtn.setOnClickListener(v -> {
            Toast.makeText(LoginActivity.this, "Facebook SignUp Coming Soon!", Toast.LENGTH_SHORT).show();
        });
    }
}
