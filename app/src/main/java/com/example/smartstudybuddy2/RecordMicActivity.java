...
public class RecordMicActivity extends AppCompatActivity {
    ...
    private Button startButton, pauseButton, stopButton, summarizeButton;
    private TextView timerText, transcriptionText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        summarizeButton = findViewById(R.id.summarizeButton); // New
        timerText = findViewById(R.id.tvTimer);
        transcriptionText = findViewById(R.id.transcriptionResult);

        pauseButton.setEnabled(false);
        stopButton.setEnabled(false);
        summarizeButton.setVisibility(View.GONE); // initially hide
        ...
        summarizeButton.setOnClickListener(v -> {
            String transcribedText = transcriptionText.getText().toString();

            Intent intent = new Intent(RecordMicActivity.this, TranscriptionActivity.class);
            intent.putExtra("transcriptionText", transcribedText);
    ...
    private void stopRecording() {
        try {
            ...
            intent.putExtra("TRANSCRIPTION_TEXT", transcribedText); // fresh transcription
            startActivity(intent);
